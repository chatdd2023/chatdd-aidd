...
import math
from aidd.inference.base_models import MolEncoder, ProteinEncoder
...
class CNNGRU(ProteinEncoder):
    def __init__(self, config):
        ...
        self.conv1d = nn.Conv1d(in_channels=config["input_dim"], out_channels=config["cnn_dim"], kernel_size=3,
                                padding=0)
...
class CNNPIPR(ProteinEncoder):
    def __init__(self, config):
        ...
        self.last_conv = nn.Conv1d(in_channels=config["hidden_dim"] * 3, out_channels=config["hidden_dim"],
